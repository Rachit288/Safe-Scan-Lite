...
<!-- Badges -->
[![Live Demo](https://img.shields.io/badge/🚀_Live_Demo-Visit_Now-00D9FF?style=for-the-badge&logoColor=white)](https://safe-scan-lite-cqnf.vercel.app/)
[![Hackathon](https://img.shields.io/badge/🏆_Hackathon-Cybersecurity_Domain-FF6B6B?style=for-the-badge)](/)
...
<!-- Quick Stats -->
<img src="https://img.shields.io/badge/Attack_Vectors-6+-red?style=flat-square" />
<img src="https://img.shields.io/badge/API_Integrations-VirusTotal_|_Google_Safe_Browsing-green?style=flat-square" />
<img src="https://img.shields.io/badge/Risk_Levels-Safe_|_Caution_|_Danger-yellow?style=flat-square" />
<img src="https://img.shields.io/badge/Response_Time-<2s-blue?style=flat-square" />
...
<img src="https://img.shields.io/badge/Safe--Scan_Lite-Your_QR_Security_Guardian-00D9FF?style=for-the-badge&logo=shield&logoColor=white" />
...
flowchart TB
    subgraph Frontend["🖥️ Frontend (React + TypeScript)"]
        A[📱 User Device] --> B[📷 QR Scanner]
        B --> C[html5-qrcode Library]
        C --> D[URL Extracted]
    end
    
    subgraph Backend["⚙️ Backend (FastAPI + Python)"]
        D --> E["/api/scan Endpoint"]
        E --> F{URL Analysis Engine}
        F --> G[🔍 Heuristic Checks]
        F --> H[🦠 VirusTotal API]
        F --> I[🔒 Google Safe Browsing]
    end
    
    subgraph Analysis["🧠 Analysis Pipeline"]
        G --> J[Attack Vector Detection]
        G --> K[Intent Classification]
        H --> L[Reputation Score]
        I --> M[Threat Database Check]
    end
    
    subgraph Output["📊 Results"]
        J --> N[Risk Score 0-100]
        K --> N
        L --> N
        M --> N
        N --> O[/Result Display/]
...
[![Framer Motion](https://img.shields.io/badge/Framer_Motion-12.33-FF0080?style=for-the-badge&logo=framer&logoColor=white)](https://www.framer.com/motion/)
...
### APIs & Integrations
[![VirusTotal](https://img.shields.io/badge/VirusTotal-API_v3-394EFF?style=for-the-badge&logo=virustotal&logoColor=white)](https://www.virustotal.com/)
[![Google Safe Browsing](https://img.shields.io/badge/Google_Safe_Browsing-API_v4-4285F4?style=for-the-badge&logo=google&logoColor=white)](https://safebrowsing.google.com/)
...
<img src="https://img.shields.io/badge/🌐_LIVE_DEMO-Click_Here_to_Try-00D9FF?style=for-the-badge&logoColor=white" height="50"/>
</a>
...
![Phishing QR](./QR%20CODE/qr-code%20(1).png)
...
![URL Shortener QR](./QR%20CODE/qr-code%20(2).png)
...
![UPI Fraud QR](./QR%20CODE/qr-code%20(3).png)
...
![Malware QR](./QR%20CODE/qr-code%20(4).png)
...
![Insecure HTTP QR](./QR%20CODE/qr-code%20(5).png)
...
![App Intent QR](./QR%20CODE/qr-code%20(6).png)
...
![Safe Website QR](./QR%20CODE/qr-code%20(7).png)
...
sequenceDiagram
    ...
    participant G as 🔒 Google Safe Browsing
    
    U->>F: Scans QR Code 📷
    F->>F: Extracts URL (html5-qrcode)
    F->>B: POST /api/scan
    
    par Parallel Analysis
        B->>B: Heuristic Checks
        B->>V: Check URL Reputation
        B->>G: Check Threat Database
    end
    
    V-->>B: Detection Results
    G-->>B: Threat Matches
    B->>B: Calculate Risk Score
    B->>B: Determine Intent
    B-->>F: Analysis Response
    F->>F: Render Results with Animations
    F-->>U: Display Risk Level + Explanation
```
...
<a href="https://safe-scan-lite-cqnf.vercel.app/">
<img src="https://img.shields.io/badge/🛡️_Try_Safe--Scan_Lite_Now-Scan_Safely!-00D9FF?style=for-the-badge" />
</a>
...
[![Star](https://img.shields.io/badge/⭐_Star_this_repo-If_you_found_it_useful!-yellow?style=flat-square)](/)
